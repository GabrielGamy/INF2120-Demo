...
public interface IRechercheBinaire {
     ...
     * @param valeurRecherchee : La valeure que l'on souhaire trouvee dans la liste
     * @return la position de valeurRecherchee ou -1 si la valeur introuvable dans la liste
     */
     ...
     * @throws RechercheBinaireException: Lance une exception si la valeure est introuvable
     */
